package com.silvertown.ecoping.domain.file.controller;
...
public class FileController {
    ...
    public ResponseEntity<?> upload(@RequestPart("file") MultipartFile file, @RequestParam int CampaignId) throws Exception {
